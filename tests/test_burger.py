...
def test_set_buns():
    ...
    assert burger.bun.get_name() == "Sesame"
    assert burger.bun.get_price() == 2.5
...
def test_get_price(bun_price, ingredients, expected_price):
    burger = Burger()
...
def test_get_receipt_parametrized(bun_name, bun_price, ingredients, expected_receipt):
    burger = Burger()
